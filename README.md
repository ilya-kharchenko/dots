...
Все материалы предоставляются «как есть», без каких-либо гарантий работоспособности на вашей системе. Перед применением рекомендуется ознакомиться с содержимым конфигурационных файлов и при необходимости сделать резервные копии своих настроек.

Используя материалы из этого репозитория, вы принимаете на себя ответственность за любые изменения, внесённые в вашу систему.
