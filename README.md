...
Все конфигурации и инструкции в этом репозитории предоставляются **«как есть»**. Перед применением рекомендуется ознакомиться с их содержимым и при необходимости сделать резервные копии своих настроек.

Все упомянутые названия программ и товарные знаки принадлежат их правообладателям.
